...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        parser.add_argument("file1", type=str, help="The path to the file1 containing the data.")
        parser.add_argument("file2", type=str, help="The path to the file2 containing the data.")
        parser.add_argument("-a", action="store_true", help="If you want all files like file1 and file2 to be concatenated.")
